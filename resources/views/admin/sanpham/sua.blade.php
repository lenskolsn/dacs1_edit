    ...
    <form action="{{ route('sanpham.luu', $sanpham->id) }}" method="post" enctype="multipart/form-data">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <x-input name="soluong" label="Số lượng" min="0" value="{{ $sanpham->soluong }}" type="number" />
                <x-input name="mau" label="Màu" placeholder="VD: Trằng, Đen" value="{{ $sanpham->mau }}"
                    type="text" />
                <x-input name="size" label="Size" placeholder="VD: M,L,XL" value="{{ $sanpham->size }}" type="text" />
            ...
            <div class="col-md-6">
                ...
                <div class="mt-3">
                    ...
                    <img id="preview_image" class="mt-3" src="/storage/{{ $sanpham->hinhanh }}" width="220"
                        alt="">
                </div>
